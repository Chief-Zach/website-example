...
export const Banner = () => {
  ...
  const toRotate = [ "Artificial Intelligence Engineer", "Data Scientist", "Team Leader" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Zach`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Artificial Intelligence Engineer", "Data Scientist", "Team Leader" ]'><span className="wrap">{text}</span></span></h1>
